    ...
    <div {...props} className={clsx("p-4", className)}>
      ...
      <div className="ml-6">
        <h3 className="line-height-tight my-0">
          <Link className="color-[--fgColor-default] break-all" href={pullRequest.html_url}>
            {pullRequest.title}
          </Link>
        </h3>
        <div className="color-[--fgColor-muted] mb-0 mt-2">
          {pullRequest.body && <Markdown text={pullRequest.body} className={styles.md} />}
        </div>
        <div className="text-xs color-[--fgColor-muted] mt-2">
